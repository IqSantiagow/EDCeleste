...
class FuelProjectionTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.fsd_jump_event = FSDJumpEvent(event="FSDJump", timestamp=datetime.now(), StarSystem="Test System",
                                           SystemAddress=123456789, StarPos=[0.0, 0.0, 0.0], SystemAllegiance="Independent",
                                           SystemEconomy_Localised="High Tech", SystemSecondEconomy_Localised="Industrial",
                                           SystemGovernment_Localised="Democracy", SystemSecurity_Localised="Low",
                                           Population=1000000, JumpDist=10.0, FuelUsed=1.0, FuelLevel=1.0, Factions=[],
                                           SystemFaction=None)
