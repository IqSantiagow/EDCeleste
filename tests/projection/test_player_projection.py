...
class PlayerProjectionTest(unittest.TestCase):
    ...
    def test_should_process_event_and_set_player_state_data(self):
        ...
        self.assertEqual(player_projection.player_name, self.loaded_game_event.Commander)
        self.assertEqual(player_projection.player_credits, self.loaded_game_event.Credits)
